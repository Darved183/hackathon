...
var Merchs = []Merch{
	{"Футболка БебраБот", "одежда", 799.99, "Стильная футболка с логотипом БебраБот."},
	{"Кружка БебраБот", "посуда", 399.50, "Керамическая кружка для настоящих фанатов."},
	{"Брелок БебраБот", "аксессуар", 199.00, "Металлический брелок с символикой."},
}
...
func main() {
	...
	fmt.Println("Добро пожаловать в БебраБот!!!\n")
	var Answer string
	for {
